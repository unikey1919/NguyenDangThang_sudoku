...
class Square(GUIBase):
    ...
    def draw(self):
        ...
        r, c = self.__pos[0] * space + \
            self.__widthpos[1], self.__pos[1] * space
        # fill unchangeable square background
        if not self.__changeable:
            sqsize = self.__widthpos[0] // 9
            # draw rectangle (frame)
            pygame.draw.rect(self.screen, (170, 183, 184),
                             ((r, c), (sqsize, sqsize)))
        # check for none 0's squares
        if self.__value != 0:
            font = pygame.font.Font(
                "C:/Users/Dang Thang/Desktop/IT/AI/sudoku/assets//Rubik-font/Rubik-Regular.ttf", 38)
            # set color
            rgb = (221, 75, 36) if not self.__wrong else (234, 72, 54)
            ...
            font = pygame.font.Font(
                "C:/Users/Dang Thang/Desktop/IT/AI/sudoku/assets//Rubik-font/Rubik-Regular.ttf", 30)
            # create suface object
        ...
        if self.__selected:
            # draw rectangle (frame)
            pygame.draw.rect(self.screen, (52, 214, 34),
                             ((r, c), (space, space)), 3)
